function [finalResults,binomVector,NoOfSuccesses] =dayFinalEnsembleClassifier(FiveCombClassifiersList,testHOGFeat, testColorFeat, testGISTFeat,testSIFTFeat,test_labels)
tic    
finalResults = [];
